...
<!-- ============================== NOTLAR ================================= -->
<!-- ======================================================================= -->
[^1]: 21080744, [Github Repo](https://github.com/slymanb/arasinav)
...
## Çalışmanın Amacı
Bu çalışmada belediyeler ve hükümetler tarafından kullanılan açık veriye dikkat çekilmesi amaçlanmaktadır.

## Literatür 
Son yıllarda dünyada açık veriye artan bir ilgi söz konusudur. Kurumların faaliyetlerini daha şeffaf ve verimli sürdürebilmeleri, hesap verilebilmeleri ve vatandaşın bilgilenmesi için, açık veri önemlidir. Kurumlar şeffaflık ilkesine bağlı kalarak faaliyet verilerini kamuya açabilmeli ve araştırmacıların bu veriden daha fazla faydalanmalarına imkân vermeleri gerekmektedir @damar2021accik. Buna yönelik olarak yurt dışındaki açık erişimli veriler için şu gibi örnekler mevcuttur: @janssen2012benefits, @veljkovic2014benchmarking, @vetro2016open)
